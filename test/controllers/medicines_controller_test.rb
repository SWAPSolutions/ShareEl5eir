...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { concentration: @medicine.concentration, description: @medicine.description, donated: @medicine.donated, exp_date: @medicine.exp_date, name: @medicine.name, quantity: @medicine.quantity, user_id: @medicine.user_id }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { concentration: @medicine.concentration, description: @medicine.description, donated: @medicine.donated, exp_date: @medicine.exp_date, name: @medicine.name, quantity: @medicine.quantity, user_id: @medicine.user_id }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
